...
def main():
    ...
    print("== Saeule 1: Verbotene Nichtdeterminismus-Quellen (v2: Code-Tokens, Allowlist-geprueft) ==")
    ...
    if unallowed:
        ...
        print(f"  OK: {len(allowed)} allowlistete Fundstelle(n) — Allowlist iterativ auf 0 reduzieren (SCR-0126)")
    else:
